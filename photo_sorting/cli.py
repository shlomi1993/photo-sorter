#!/usr/bin/env python3
"""
CLI entry point for the Photo Sorting Tool.

This module provides the command-line interface that gets installed as 'photo-sorting' command.
"""
...
def extract_date_from_filename(filename: str) -> Optional[Union[date, datetime]]:
    """
    ...
    if timestamp_match:
        ...
        try:
            return datetime.strptime(date_part + time_part, timestamp_format)
        except ValueError:
            pass
